        ...
        public ApiResponse<String> registerPatient(RegisterPatientRequest request) {
                ...
                try {
                        ...
                        throw new RuntimeException(
                                        "Patient User created, but failed to sync with Patient Service: "
                                                        + e.getMessage());
                }
                        ...
                        try {
                                ...
                                String adminMessage = String.format(
                                                "Dear Administrator,\n\n" +
                                                                ...
                                                                "Regards,\n" +
                                                                "Medisphere System",
                                                request.getFirstName(), request.getLastName(), request.getSpecialty(),
                                                request.getEmail());
                ...
                if ("DOCTOR".equalsIgnoreCase(user.getRole())) {
                        try {
                                ...
                                CreateDoctorDTO createDoctorDTO = CreateDoctorDTO.builder()
                                                .firstName(userDto.getFirstName() != null
                                                                && !userDto.getFirstName().isEmpty()
                                                                                ? userDto.getFirstName()
                                                                                : "NA")
                                                .lastName(userDto.getLastName() != null
                                                                && !userDto.getLastName().isEmpty()
                                                                                ? userDto.getLastName()
                                                                                : "NA")
                                                .doctorId(user.getMsUserId())
                                                .msUserId(user.getMsUserId())
                                                .specialty(userDto.getSpecialty() != null
                                                                && !userDto.getSpecialty().isEmpty()
                                                                                ? userDto.getSpecialty()
                                                                                : "General")
                                                .drLicence(userDto.getLicenseUrl() != null
                                                                && !userDto.getLicenseUrl().isEmpty()
                                ...
                                throw new RuntimeException("User created, but failed to sync with Doctor Service: "
                                                + e.getMessage());
                        }
                }
